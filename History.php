...
<div class="top">
    ...
    <?php
      ...
      FROM users 
      JOIN shoporder ON shoporder.id_customer = users.id
      JOIN product ON shoporder.Product_ID = product.Product_ID
      JOIN order_list ON shoporder.ID_Order = order_list.Order_ID
      ...
      while($row = $stmt->fetch()){ 
        ...
        <tr>
        <td><?=$row["id"]?><br></td>
        <td><?=$row["firstname"]?><br></td>
        <td><?=$row["lastname"]?><br></td>
        <td><?=$row["phone"]?><br></td>
        <td><?=$row["address"]?><br></td>
        <td><?=$row["ID_Order"]?><br></td>
        <td><?=$dateThai?><br></td>
        <td><?=$row["Status"]?><br></td>
        <td><a href="infoproduct.php?Product_ID=<?=$row["Product_ID"]?>"><?=$row["Product_ID"]?></a><br></td>
